...
if($_POST)
{
    ...
    if($resultat->num_rows != 0)
    {
        ...
        {
            $contenu .= '<local_error class="erreur">Erreur de MDP</local_error>';
        }       
    }
    else
    {
        $contenu .= '<local_error class="erreur">Erreur de pseudo</local_error>';
    }
}
//--------------------------------- AFFICHAGE HTML ---------------------------------//
?>
...
<form method="post" action="">
    <label for="pseudo">Identifiant (pseudo)</label><br>
